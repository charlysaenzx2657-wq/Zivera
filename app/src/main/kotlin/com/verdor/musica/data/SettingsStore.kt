...
object Keys {
    ...
    val OFFLINE_MODE = booleanPreferencesKey("offline_mode_manual")
...
class SettingsStore(private val context: Context) {
    ...
    val offlineModeManual: Flow<Boolean> = context.dataStore.data.map { it[Keys.OFFLINE_MODE] ?: false }
    ...
    suspend fun setOfflineModeManual(v: Boolean) = context.dataStore.edit { it[Keys.OFFLINE_MODE] = v }
